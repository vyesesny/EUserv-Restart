### 目前IPV6 only的vps添加DNS64已无意义，因为有更加好的WARP解决方案，有德鸡EUserv后第一件事就是刷这个脚本：请看该项目脚本 https://github.com/YG-tsj/EUserv-warp
...
若使用Github Actions运行本脚本，将会公开你的账号中VPS个数以及VPS的ID（**Contr
